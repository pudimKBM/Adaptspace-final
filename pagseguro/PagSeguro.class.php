<?
class PagSeguro{
	private $email         = "adm@adaptspace.com.br";
	//private $token_sandbox = "TOKEN DO SANDBOX";
	private $token_oficial = "E105F5A60F4B4B23B388570BF17DCC26";
	private $url_retorno   = "http://adaptpace.com.br/pagseguro/notificacao.php";
	...
	*/
	...
	private function generateUrl($dados,$retorno){
		...
		//Tratar telefone
		$telefone = substr($dados['telefone'],3,strlen($dados['telefone']));

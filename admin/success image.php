...
if (isset($_POST['done'])) {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["thumbnail"]["tmp_name"], $file)) {} else {
    ...
    // adding product
    $queryaddproduct = "INSERT INTO product(id_category, name, description, price, id_picture, thumbnail, id_usr)
  VALUES ('$id_category', '$name', '$description','$price', '$idproduct', '$img_title' , '$id')";

...
error_reporting(E_ALL);
                        ...
                        <div class="col-lg-6 col-md-6 col-12 my-sm-0 my-3">
                            <div class="box bg-light rounded border p-3">
                                    ...
                                    <div class="box-text bg-light text-center border px-5">
                                        <div class="row">
                                            <input class="form-control mx-auto" type="text" name="" id="np" placeholder="Digite o titulo do produto">
                                        </div>
                                        <hr>
                                        <div class="row">
                                    ...
                                    <div>
                                        <form action="success-unique.php" method="post">
										...
										<input type="text" id="prcf" name="prcf"  value="49.90" hidden> 
										<input type="text" id="prcf2" name="prcf2" value="4.90" hidden> 
										...
										<input id="category" name="id" type="number" value=<?= $_SESSION['id'] ?> hidden>
                                            <input type="submit" value="Criar produto" id="finishBtn" class="ext btn btn-orange px-4 my-2">
                                            </form>
                                        </div>
    ...
    <script src="js/designer-unique.js"></script>

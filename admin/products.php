	...
	<div class="container current-page">
		<nav>
			<div class="nav-wrapper">
				<div class="col s12">
					<a href="index" class="breadcrumb">Dashboard</a> <a href="products"
						class="breadcrumb">Stock</a>
				</div>
			</div>
		</nav>
	</div>
           ...
           <div class="col s12 m4">
				<div class="card hoverable animated slideInUp wow">
					<div class="card-image">
						<a
							href="productstock.php?id=<?= $id_cat; ?>&category=<?= $name; ?>&icon=<?= $icon; ?>">
							<img src="src/img/<?= $icon; ?>.png" alt="">
						</a> <span class="card-title blue-text"><?= $name; ?>s</span>
					</div>
